...
namespace DAL
{
    public class DALKyLuong
    {
        ...
        public DALKyLuong(string conn) => _databaseContext = new PersonnelManagementDataContext(conn);

        // Danh sach Ky Luong
        public List<KyLuong> DsKyLuong() => _databaseContext.KyLuongs.ToList();

        // Tim Ky Luong qua id
        public KyLuong TimKyLuongQuaID(int id) => _databaseContext.KyLuongs.FirstOrDefault(p => p.id == id);
        ...
        public bool ThemKyLuong(DTOKyLuong DTO)
        {
            try
            {
                ...
                _databaseContext.KyLuongs.InsertOnSubmit(kyLuong);
        ...
        public bool XoakyLuong(DTOKyLuong DTO)
        {
            try
            {
                ...
                if (kyLuong != null)
                {
                    _databaseContext.KyLuongs.DeleteOnSubmit(kyLuong);
                    _databaseContext.SubmitChanges();
